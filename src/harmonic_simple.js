...
// harmonic regression
// Function to add time, and constant variables to dataset
...
multiSat = multiSat.map(addVariables);

// List of the independent variable names.
var independents = ee.List(['constant', 't']);
// Name of the dependent variable.
var dependent = ee.String('visnirAlbedo');

// Use these independent variables in the harmonic regression.
var harmonicIndependents = ee.List(['constant', 't', 'cos', 'sin']);
// Add harmonic terms as new image bands.
var harmonicAlbedo = multiSat.map(function(image) {
...
var harmonicTrend = harmonicAlbedo
...
var fittedHarmonic = harmonicAlbedo.map(function(image) {
...
print(ui.Chart.image.series(fittedHarmonic.select(['fitted', 'visnirAlbedo']), aoi,
      ee.Reducer.mean(), 30)
  .setSeriesNames(['fitted', 'hsa'])
  .setOptions({
