function f_slope = func_corrmap_regression_darkzone(imfolder)
...
exportgraphics(f_slope, "..\print\darkzone\corrmap_bid_slope.png", "Resolution", 300);
close(f_slope);
...
exportgraphics(f_intercept, "..\print\darkzone\corrmap_bid_intercept.png", "Resolution", 300);
close(f_intercept);
...
exportgraphics(f_r2, "..\print\darkzone\corrmap_bid_r2.png", "Resolution", 300);
close(f_r2);
...
exportgraphics(f_slope_am, "..\print\darkzone\corrmap_am_slope.png", "Resolution", 300);
close(f_slope_am);
...
exportgraphics(f_intercept_am, "..\print\darkzone\corrmap_am_intercept.png", "Resolution", 300);
close(f_intercept_am);
...
exportgraphics(f_r2_am, "..\print\darkzone\corrmap_am_r2.png", "Resolution", 300);
close(f_r2_am);
end